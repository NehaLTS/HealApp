...
import { ClientUserContext, UseClientUserContext } from 'contexts/UseClientUserContext'
...
const OnBoardingView = () => {
  ...
  const getLocalUserData = async () => {
    ...
    if (userResponse?.token != null) {
      ...
      const userData: ClientProfile = (await getLocalData('USERPROFILE')) as ClientProfile
  ...
  return (
    <View style={styles.slide}>
      ...
      <Swiper ref={swiperRef} activeDotStyle={styles.activeDotStyle} activeDotColor={colors.primary} containerStyle={styles.containerStyle}>
        {[...Array(3)].map((_, index) => (
