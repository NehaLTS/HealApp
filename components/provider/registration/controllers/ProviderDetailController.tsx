...
const ProviderDetailController = () => {
    ...
    const onBlurTypeProvider = () => setUserDataProvider({ ...userDataProvider, type_Provider: typeProviderRef.current.value })
    const onChangeTypeProvider = (value: string) => typeProviderRef.current.value = value
    const onBlurSpeciality = () => setUserDataProvider({ ...userDataProvider, speciality: specialityRef.current.value })
    const onChangeSpeciality = (value: string) => specialityRef.current.value = value
    return {
        userDataProvider,
        firstNameRef,
        lastNameRef,
